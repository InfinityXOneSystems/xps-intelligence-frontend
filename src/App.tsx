  ...
  return (
    <ThemeProvider>
      <div className="h-screen w-screen flex flex-col overflow-hidden relative bg-background text-foreground transition-colors duration-300">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_90%_40%,rgba(183,112,40,0.03),transparent_45%)] pointer-events-none dark:opacity-100 opacity-30" />
        ...
        <div className="absolute inset-0 bg-[linear-gradient(135deg,rgba(212,175,55,0.02)_0%,transparent_25%,rgba(192,192,192,0.015)_50%,transparent_75%,rgba(183,112,40,0.01)_100%)] pointer-events-none dark:opacity-100 opacity-30" />
