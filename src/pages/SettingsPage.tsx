  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Configure your dashboard preferences and system settings</p>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          {systemIndicators.map((indicator, index) => {
            ...
            return (
              ...
              >
                <Card
                  className="glass-card p-5 hover:border-border-hover transition-all"
                >
