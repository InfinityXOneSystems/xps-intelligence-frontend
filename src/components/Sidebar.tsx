    ...
    >
      ...
      <div className="relative p-4 border-t border-border-subtle">
        <div 
          ...
          style={{
            background: 'linear-gradient(135deg, var(--gradient-maroon-start) 0%, var(--gradient-maroon-mid) 50%, var(--gradient-maroon-end) 100%)',
            borderColor: 'rgba(139, 0, 35, 0.4)',
            boxShadow: 'var(--glow-maroon)',
          }}
        >
          ...
          {!collapsed && (
            <div className="flex-1">
              ...
              <div className="text-[10px] text-white/70">Elite Mode</div>
            </div>
          )}
        </div>
      </div>
