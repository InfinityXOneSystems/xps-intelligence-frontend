...
type ChartTooltipContentProps =
  RechartsPrimitive.DefaultTooltipContentProps<number | string | (number | string)[], number | string> & {
    active?: boolean
    color?: string
    hideLabel?: boolean
    ...
    >
      ...
      <div className="grid gap-1.5">
        {payload.map((item, index) => {
          ...
          return (
            <div
              key={typeof item.dataKey === "function" ? String(index) : `${item.dataKey ?? item.name ?? index}`}
              className={cn(
